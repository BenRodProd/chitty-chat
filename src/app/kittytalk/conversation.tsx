export const conversationDatas = (latestMessage: any) => [
  ...
  },
  {
    ...
    responses: [
      `Kuckuck, ${latestMessage.user[0]}!`,
      `Hallo, ${latestMessage.user[0]}!`,
      `Hi ${latestMessage.user[0]}!`,
      `Hey ${latestMessage.user[0]}!`,
      `Hola, ${latestMessage.user[0]}!`
    ]
  },
  {
    buzzwords: ['tschüss', 'bye', 'ciao'],
    responses: [
      `Auf Wiedersehen, ${latestMessage.user[0]}`,
      'Ciao, miau',
      'Tschöö mit Ö',
      'Ciao Kakao!'
    ]
  },
  {
    ...
    responses: [
      `Du heißt ${latestMessage.user[0]}!`,
      `Ist doch klar! Du heißt doch ${latestMessage.user[0]}!`
    ]
  },
  {
    buzzwords: ['🐟', '🐠'],
  ...
  },
  {
    ...
    responses: [
      'Ich habe riesigen Hunger! Hast du was zu essen für mich?',
      'Hast du Katzenfutter?',
      'Hast du einen Fisch für mich?'
    ],
    NEXT: 'ESSEN',
    ANIMATION: 'MundAuf'
  },
  ...
  },
  {
    ...
    responses: [
      ...
      'Hunger... Sonst alles gut! Und bei dir?'
    ],
    NEXT: 'WIEGEHTS'
  },
  {
    ...
    responses: [
      'Schade! Soll ich Dir einen Katzenwitz erzählen?',
      'Das tut mir leid! Soll ich dir einen Katzenwitz erzählen',
      'Mmmhh... Soll ich versuchen, dich aufzumuntern?'
    ],
    NEXT: 'FRAGE-WITZ'
  },
  {
  ...
  },
  {
    ...
    responses: [
      'Soll ich einen Katzenwitz erzählen?',
      'Möchtest du einen Katzenwitz hören?',
      'Ich kenne viele Katzenwitze. Möchtest du einen hören?'
    ],
    NEXT: 'FRAGE-WITZ'
  },
  {
    ...
    responses: [
      ...
      "Was ist der Unterschied zwischen Hund und Katze? Der Hund denkt sich 'Mein Herrchen gibt mir immer Futter, ich glaube mein Herrchen ist Gott!' Die Katze denkt sich: 'ich bekomme immer Futter, ich glaube, ich bin Gott!'",
      'Wo wohnen Katzen? Im Mietzhaus!',
      'Warum sind Katzen gute Zocker? Weil sie sieben Leben haben!',
      'Warum hat die Katze neben dem Computer gesessen? Weil sie die Maus im Auge behalten wollte!',
      'Warum hat die Katze eine Leiter mit in die Bar gebracht? Weil sie gehört hat, dass die Getränke aufs Haus gehen!'
    ],
    NEXT: 'ALL'
  },
  {
  ...
  },
  {
    ...
    responses: [
      'Ich bin ein kleines Kätzchen! Keine Ahnung, wie alt ich bin...',
  ...
  },
  {
    ...
    responses: [
      'Ich spiele gerne mit Spielzeug!',
      'Wirf den Ball!',
      'Die Maus ist mein Lieblingsspielzeug.'
    ]
  },
  {
    ...
    responses: [
      ...
      'Ich bin immer bereit für den Job!',
      'Brauchst du Hilfe bei der Arbeit?'
    ]
  },
  {
  ...
  },
  {
    ...
    responses: [
      'Spaziergänge in der Natur sind entspannend.',
      'Ich liebe die Natur.',
      'Wohin gehst du gerne spazieren?'
    ]
  },
  {
    buzzwords: ['sitz'],
  ...
  },
  {
    ...
    responses: [
      'Bücher sind eine Schatzkiste der Weisheit.',
  ...
  },
  {
    ...
    responses: [
      'Kinoabende sind toll!',
      'Ich mag Filme.',
      'Popcorn und ein guter Film sind perfekt!'
    ]
  },
  {
  ...
  },
  {
    ...
    responses: [
      'Schnee macht die Welt magisch.',
      'Ich mag den Winter.',
      'Ein heißer Kakao im Schnee ist gemütlich.'
    ]
  },
  {
  ...
  },
  {
    ...
    responses: [
      'Gärten sind voller Leben.',
      'Ich mag bunte Blumen.',
      'Pflanzen bringen Frische ins Haus.',
  ...
  },
  {
    ...
    responses: [
      ...
      'Sorgst du gut für deine Gesundheit?',
      'Ärzte sind Helden.'
    ]
  },
  {
    ...
    responses: [
      ...
      'Die Vergangenheit hat viel zu erzählen.',
  ...
  },
  {
    ...
    responses: [
      'Kaffee oder Tee? Oder doch einfach Milch? Mmhmhhh... Lecker Milch!',
      'Eine Tasse Tee wärmt die Seele.',
      'Milch am Morgen ist ein Genuss.'
    ]
  },
  {
  ...
  },
  {
    ...
    responses: [
      ...
      'Sternenhimmel ist faszinierend.',
      'Nachtstunden sind magisch.'
    ]
  },

  {
    ...
    responses: [
      ...
      'Hast du eine Lieblingsuhrzeit? Ich mag die Nacht am liebsten...',
      'Sekunden zählen können ist eine Kunst.'
    ]
  },
  {
    buzzwords: ['filme', 'kino', 'popcorn'],
    responses: [
      'Popcorn und Filme, eine gute Kombination.',
      'Welchen Film hast du zuletzt gesehen?',
      'Kinoabende sind gemütlich.'
    ]
  },
  {
    buzzwords: ['tagebuch', 'schreiben', 'geheimnis'],
    responses: [
      'Ein Tagebuch bewahrt Geheimnisse.',
      'Schreibst du ein Tagebuch?',
      'Geheimnisse machen das Leben spannend.'
    ]
  },
  {
    buzzwords: ['fliegen', 'himmel', 'wolken'],
    responses: [
      'Fliegen wäre aufregend.',
      'Himmel und Wolken sind faszinierend.',
      'Träumen vom Fliegen.'
    ]
  },
  {
  ...
  },
  {
    ...
    responses: [
      'Ich bin mir nicht sicher. Ich kann nicht nach draußen sehen!',
      'Ich wünschte, ich könnte es dir sagen, aber ich bin drinnen.'
    ]
  },
  {
    buzzwords: ['lieblingsessen', 'was isst du gerne', 'essensvorlieben'],
    responses: [
      'Ich mag Katzenminz-Snacks!',
      'Ich genieße Fisch und Katzenfutter.',
      'Ich liebe alles, was für Katzen essbar ist!'
    ]
  },
  {
    buzzwords: ['lieblingsspielzeug', 'spielzeit', 'spielzeug'],
    responses: [
      'Ich liebe es, mit Feder-Spielzeug zu spielen!',
      'Alles mit Glöckchen und Schnüren ist mein Favorit.',
      'Ich stehe auf Laserpointer und Spielzeugmäuse!'
    ]
  },
  {
    buzzwords: ['erzähl mir eine Geschichte', 'geschichtenzeit', 'es war einmal'],
    responses: [
      'Es war einmal in einem fernen Land eine neugierige und abenteuerlustige Katze namens Kitty. Kitty liebte es, die Welt zu erkunden, und erlebte viele aufregende Abenteuer. Ende...'
    ]
  },
  {
    buzzwords: ['stimmt', 'richtig', 'da hast du recht'],
    responses: [
      'Ich bin eine schlaue Katze!',
      'Damit kenne ich mich aus!',
      'Klar habe ich recht! Ich bin eine Katze! Die haben meistens recht!'
    ]
  },
  {
    buzzwords: ['😎'],
